...
func cmGetDevNodeProperty(dnDevInst uint32, propertyKey *devPropKey, propertyType *uint64, propertyBuffer *byte, propertyBufferSize *uint64, uFlags uint64) (hr error) {
